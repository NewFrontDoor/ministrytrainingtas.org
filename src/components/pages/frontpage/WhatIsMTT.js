      ...
      <div className="row">
        <div className="col-md-12">
          <div className="section-title">
            ...
            <h2 className="aquaHeader">Tasmania’s natural advantage</h2>
            <p>Training in Tasmania is also a unique opportunity. Ministry in a regional city is more integrated and holistic than it can be in larger cities. Rather than spending a lot of time on public transport or working in a single ministry silo, it is possible to enjoy rich interdependence and collaboration with different churches and parachurches across the city and the State. On top of all of this is Tasmania’s beautiful natural environment and vibrant cultural life.</p>
          </div>
        </div>
      </div>
    </div>
